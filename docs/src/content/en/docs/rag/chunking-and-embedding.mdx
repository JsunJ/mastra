...
For markdown documents where you want to preserve semantic relationships between sections, here's an example of how to use the `semantic-markdown` strategy:
